...
sudo apt-get update
sudo apt-get install unzip apt-transport-https
...
sudo apt-get update
sudo apt-get install -y elasticsearch=6.7.1
...
#sudo mkdir /etc/elasticsearch/hunspell/
...
#####################################################################################
#
sudo apt-get install -y kibana=6.7.1
...
#####################################################################################
#
sudo /usr/share/elasticsearch/bin/elasticsearch-plugin install pl.allegro.tech.elasticsearch.plugin:elasticsearch-analysis-morfologik:6.7.1
